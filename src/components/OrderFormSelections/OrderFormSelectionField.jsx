...
buraya fakeData'dan pişme derecesi gibi şeyler verilebilinir */}
        ...
        <div className="Form-Summary-Area">
          ...
          <div className="Product-Order-Quantity">
            <button type='button' className="QuantityBtn-Left" onClick={quantityDown}>
              -
            </button>
            <p className="QuantityNumber">{orderquantity}</p>
            <button  type='button' className="QuantityBtn-Right" onClick={quantityUp}>
              +
            </button>
          </div>
          ...
          <div className="Form-TotalPrice">
            ...
            <button type="submit" disabled={isSubmitDiasble} className="Order-Sent-Btn">
              {" "}
              SİPARİŞ VER
            </button>
          </div>
